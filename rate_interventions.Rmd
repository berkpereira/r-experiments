---
title: "Modelling other interventions that change transmission rates"
output:
...
pkgdown:
  as_is: true
vignette: >
  %\VignetteIndexEntry{Modelling other interventions that change transmission rates}
...
## Modelling an intervention on transmissibility

We model an intervention on the transmissibility $\beta$ that reduces it by 10%.
...
We simulate an epidemic using `model_default_cpp()`, calling the default model outlined in the ["Get started vignette"](epidemics.html).
